...
export function HelpCenter() {
  ...
  return createPortal(
    <div
      ...
      className="fixed inset-0 z-[9000] flex items-center justify-center p-4 pb-20 lg:pb-4 bg-black/50 backdrop-blur-sm"
      onClick={(e) => { if (e.target === e.currentTarget) closeCenter() }}
    >
      <div className="w-full max-w-2xl max-h-[calc(100vh-6rem)] lg:max-h-[90vh] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
